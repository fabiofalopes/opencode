...
2. **`CONDUCTOR_ANALYSIS_REPORT.md`** - Análise profunda do problema do Conductor
...
2. **Se continuar com problemas:**
   - Aplicar as correções da prompt do Conductor (no relatório `CONDUCTOR_ANALYSIS_REPORT.md`)
